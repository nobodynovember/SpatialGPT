    ...
    def make_candidate(self, scanId, viewpointId, viewId):
        ...
        if long_id not in self.buffered_state_dict:
            for ix in range(36):
                ...
                # print('its heading:', loc_heading)
                # print('its base_heading:', base_heading)
                # print('its state.heading:', state.heading)
                ...
                for j, loc in enumerate(state.navigableLocations[1:]):
                    ...
                    if (loc.viewpointId not in adj_dict or
                        ...
                        # print('candidate viewpointId:', loc.viewpointId)
                        # print('its heading:', loc_heading)
                        # print('its base_heading:', base_heading)
                        # print('its state.heading:', state.heading)
                        # print('its normalized_heading:', state.heading + loc.rel_heading)
                        # print('its viewIndex:', state.viewIndex)
                        # print('its absolute_heading:', state.heading)
                        # print('env make candidate its img_path:', img_path)
    ...
    def _get_obs(self):
        ...
        for i, state in enumerate(self.env.getStates()):
            ...
            if 'instr_encoding' in item.keys():
                ...
                instr_encoding = None
            #print('instr_encoding:', instr_encoding)
            ob = {
